      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Get a complete cost breakdown for your New Zealand road trip including fuel, tolls, and ferry charges. 
            Plan your journey with confidence knowing all your travel expenses upfront.
          </p>
        </div>
